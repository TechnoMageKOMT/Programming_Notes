...
The most popular CDN is Google's (there is a link to the snippets on the jquery.com download section). Use the `<script>` tag with the latest version of jQuery (3.6.0 at the writing of this document March 2021).
